...
export default function Home() {
    ...
    useEffect( () => {
        axios.get(`https://youtube-backend-pvou.onrender.com/api/user/verfy/${token}`).then(res => {
            if(res.status === 200){
    ...
    useEffect(() => {
        axios.get(`${API}/api/files?fileName=${fileName}`).then(res => {
      ...
      <div class="container1">
        <header class="header">
          ...
          <form action="#" class="search-box1">
            ...
            >
              <img src={mic} alt="mic" width="20" height="25" />
            </button>
          </form>
          <section class="header-right">
            ...
            <button class="hover-after">
             ...
             <img
                class="avatar-img"
                src={ token ? `${API}/`+data.profilImg : avatar}
                alt="avatar-img"
                width="32px"
                height="32px"
              />
        ...
        <main class="main">
          <div class="left-menu-wrapper">
            <ul class="navbar-list">
              ...
              {
                users.map(user => {
                    return <li class="channel" data-id="1">
                    <a>
                      <img src={`${API}/` + user.profilImg} alt="channel-icon" width="30px" height="30px" />
          ...
          <div class="iframes-wrapper">
            <ul class="iframes-list">
            {
                    files.map(file => {
                        ...
                        <object data={`${API}/` + file.file} width="400px" height="250px"></object>
                        <div class="iframe-footer">
                            <img src={`${API}/` + file.user.profilImg} alt="channel-icon" />
